...
public class DispensingApiConstants {

    public static final String DISPENSING_MODULE_ID = "dispensing";

    public static final String DISPENSING_HTML_FORM = "dispensing:htmlforms/dispensing.xml";
